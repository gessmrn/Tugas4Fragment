...
public class HeroesData {
    ...
    public static ArrayList<com.example.tugas4.Heroes> getHeroList() {
        com.example.tugas4.Heroes tModel = null;
        ArrayList<com.example.tugas4.Heroes> list = new ArrayList<>();

        for (int i = 0; i < heroNames.length; i++) {
            tModel = new com.example.tugas4.Heroes();
