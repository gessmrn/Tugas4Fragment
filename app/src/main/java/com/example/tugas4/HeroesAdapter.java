...
public class HeroesAdapter extends RecyclerView.Adapter<HeroesAdapter.ViewHolder> {
    ...
    private ArrayList<com.example.tugas4.Heroes> listHero = new ArrayList<>();
    ...
    public ArrayList<com.example.tugas4.Heroes> getListHero(){ return listHero; }

    public void setListHero(ArrayList<com.example.tugas4.Heroes> listHero) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.btnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, com.example.tugas4.DetailPahlawan.class);
                intent.putExtra("img_url", getListHero().get(i).getHeroImage());
                intent.putExtra("title", getListHero().get(i).getHeroName());
                Intent putExtra = intent.putExtra("detail", getListHero().get(i).getHeroDetail());
